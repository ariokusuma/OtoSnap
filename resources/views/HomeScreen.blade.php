        ...
        <section class="flex items-center justify-center mt-48 mb-8 bg-bekgron ">
            ...
            <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12 ">
                ...
                <div class="flex flex-col mb-8 lg:mb-16 space-y-4 sm:flex-row sm:justify-center sm:space-y-0 sm:space-x-4">
                    ...
                    <a href="team" class="inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center text-gray-900 rounded-lg border bg-abu hover:bg-gray-100 focus:ring-4 focus:ring-gray-100">
                        Tentang Kami
        ...
        <section class=" mt-48 mb-32">
            <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
                <div class="max-w-screen mb-8 lg:mb-16 text-center">
                    <h2 class="mb-4 text-4xl tracking-tight items-center justify-center font-extrabold text-gray-900 dark:text-white">Oto-Ecosystem</h2>
                    {{-- <h4 class="mb-4 text-3xl tracking-tight items-center justify-center font-extrabold text-gray-900 dark:text-white">Kami Memiliki sederet fitur yang di buat khusus untuk Anda</h4> --}}
                    <p class="text-gray-500 sm:text-xl dark:text-gray-400">Sederet fitur yang di buat khusus hanya untuk Anda</p>
                </div>
                ...
                <div class="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
                    ...
                    <div>
                        <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-biru3 lg:h-12 lg:w-12 dark:bg-primary-900">
                            <svg class="w-5 h-5 text-biru lg:w-6 lg:h-6" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M6 6V5a3 3 0 013-3h2a3 3 0 013 3v1h2a2 2 0 012 2v3.57A22.952 22.952 0 0110 13a22.95 22.95 0 01-8-1.43V8a2 2 0 012-2h2zm2-1a1 1 0 011-1h2a1 1 0 011 1v1H8V5zm1 5a1 1 0 011-1h.01a1 1 0 110 2H10a1 1 0 01-1-1z" clip-rule="evenodd"></path><path d="M2 13.692V16a2 2 0 002 2h12a2 2 0 002-2v-2.308A24.974 24.974 0 0110 15c-2.796 0-5.487-.46-8-1.308z"></path></svg>
                        </div>
                        <h3 class="mb-2 text-xl font-bold ">OtoRescue</h3>
                    ...
                    <div>
                        ...
                        <h3 class="mb-2 text-xl font-bold ">OtoFinder </h3>
                    ...
                    <div>
                        ...
                        <h3 class="mb-2 text-xl font-bold dark:text-white">OtoHistory</h3>
                    ...
                    <div>
                        ...
                        <h3 class="mb-2 text-xl font-bold ">OtoBook</h3>
                    ...
                    <div>
                        ...
                        <h3 class="mb-2 text-xl font-bold ">OtoInsurance</h3>
                    ...
                    <div>
                        ...
                        <h3 class="mb-2 text-xl font-bold ">OtoSupport</h3>
                    ...
                    <div>
                        ...
                        <h3 class="mb-2 text-xl font-bold ">OtoShop</h3>
                        <p class="text-gray-500 ">Keep your company’s lights on with customizable, iterative, and structured workflows built for all efficient teams and individual.</p>
                    </div>
                    {{-- ########## --}}
                    <div>
                        ...
                        <h3 class="mb-2 text-xl font-bold ">OtoCare</h3>
                        <p class="text-gray-500 ">Keep your company’s lights on with customizable, iterative, and structured workflows built for all efficient teams and individual.</p>
                    </div>
                </div>
            </div>
